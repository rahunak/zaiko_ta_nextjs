export const services = [
  { name: "Ламинирование ресниц", price: "45 BYN", duration: "60 мин", desc: "Стойкий эффект завитых и ухоженных ресниц до 6–8 недель" },
  { name: "Долговременная укладка бровей (+окрашивание)", price: "35/40 BYN", duration: "40-60 мин", desc: "Аккуратные, оформленные брови с укладкой на 4–6 недель" },
  { name: "Окрашивание и коррекция бровей", price: "30 BYN", duration: "30 мин", desc: "Придание формы и насыщенного цвета бровям" },
  { name: "Коррекция бровей", price: "20 BYN", duration: "20 мин", desc: "Придание бровям идеальной формы под тип лица" },
